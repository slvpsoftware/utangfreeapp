...
import { StorageUtils, CalculationUtils } from '../utils';
import { Button } from '../components/Button';
import { UtangCard } from '../components/UtangCard';
import { Chip } from '../components/Chip';

export const ViewUtangListScreen: React.FC<NavigationProps> = ({ navigation }) => {
  ...
  const handleAddUtang = () => {
    navigation.navigate('AddUtang', { isFirstTime: false });
  };
