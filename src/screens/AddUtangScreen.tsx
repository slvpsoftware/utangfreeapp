...
import { StorageUtils, DateUtils, CalculationUtils } from '../utils';
import { Button } from '../components/Button';
import { Input } from '../components/Input';

interface AddUtangScreenProps extends NavigationProps {
  isFirstTime?: boolean;
}

export const AddUtangScreen: React.FC<AddUtangScreenProps> = ({ 
  navigation, 
  route 
}) => {
